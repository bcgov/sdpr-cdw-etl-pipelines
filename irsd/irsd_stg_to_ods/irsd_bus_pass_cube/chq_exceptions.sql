merge into irsd_bus_pass_cube target using (
    select 	/*parallel 4 */	 t.BEN_MTH_DT, 
        ...
        t.cdw_exception_txt,  
        t.source_issues_txt  
    from irsd_bus_pass_chq_exception t 
...
set target.chq_exception = nvl(src.cdw_exception_txt,'Unspecified'), 
    target.chq_src_exception = nvl(src.source_issues_txt,'Unspecified')
;